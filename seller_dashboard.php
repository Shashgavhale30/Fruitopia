    ...
    <main>
        ...
        <section class="season-fruits">
            ...
            <div class="season-cards">
                <!-- Summer Season Card -->
                <div class="season-card" onclick="window.location.href='add_fruit.php?season=summer'" style="cursor: pointer;">
                ...
                <!-- Rainy Season Card -->
                <div class="season-card" onclick="window.location.href='add_fruit.php?season=rainy'" style="cursor: pointer;">
                    <div class="season-img">
                        <img
                ...
                <!-- Winter Season Card -->
                <div class="season-card" onclick="window.location.href='add_fruit.php?season=winter'" style="cursor: pointer;">
                    <div class="season-img">
                        <img
